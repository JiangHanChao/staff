...
<script>
    ...
    function onDeleteEm(id){
        var url="${ctx}/admin/emergencyContact/delete?ids="+id;
        check_del(url);
    }

    function onDeleteEd(id){
        var url ="${ctx}/admin/education/delete?ids="+id;
        check_del(url);
    }

    function onDeleteEx(id){
        var url ="${ctx}/admin/experience/delete?ids="+id;
        check_del(url);
    }

    function onDeletefa(id){
        var url ="${ctx}/admin/family/delete?ids="+id;
        check_del(url);
    }
</script>
</body>
